...
class Product_model(models.Model):
    ...
    is_sale=models.BooleanField(default=True, verbose_name='شامل تخفیف میشود')
    sale_price=models.DecimalField(default=0, decimal_places=0, blank=True, max_digits=12, verbose_name='قیمت تخفیف خورده')
